...
_Figure 2.4 Code snippet to determine the ten most frequently occurring features _ 
...
_Figure 2.5 Code snippet to create a data frame to visualize the ten most frequently occurring features _
...
_Figure 2.6 Heatmap to show the ten most occurring features in the dataset  _
...
1. One-Hot Encoding for Feature Representation
...
2. Creating Data Structures for Encoding
...
_Figure 2.9 Showing Sparse Feature Matrix of the first 550 features of the first 100 nodes _



5. Constructing a Graph
...
3. Building models
1. GNN Model 
    1. Description of the GNN Model 
...
_Figure 3.2 Code snippet showing the train_social function_
    ...
    The `_masked_loss`_ function calculates a specialized loss for graph-based tasks. It employs a binary mask to assign different weights to data points, focusing on the relevant portions of the graph. This weighted loss measures how well the model's predictions match the ground truth labels, emphasizing data points specified by the mask. It's a vital tool for ensuring the model's attention is directed to the graph elements that matter most in applications where not all nodes or edges are equally significant.
...
_           Figure 3.4 Code snippet showing the masked_accuracy function_
...
2. Naive Bayes 
    4. Description of the Naive Bayes Model
    ...
    - For each fold, a Gaussian Naive Bayes classifier is instantiated_ (`naive_bayes_classifier = GaussianNB()`)_ and trained using the training data _(`X_train, y_train`)_.


    - Predictions are made on the test data_ (`X_test`)_, and accuracy is calculated using _`accuracy_score_`.
...
_Figure 3.8 Showing the Actual Labels VS Predicted Labels _
...
3. Logistic Regression
    7. Description of the Logistic Regression Model
...
_Figure 3.9 Code snippet showing the logistic regression model _
    ...
    8. Training of the  Logistic Regression Model
...
_Figure 3.10 Showing the accuracies of the logistic regression model _


![alt_text](images/image26.png "image_tooltip")


_Figure 3.11 Showing the confusion matrix of the logistic regression model _
...
_Figure 3.12 Showing the Actual Labels vs. predicted Labels of the logistic regression model _
...
_Figure 5.1 Showing the accuracies of three model _
